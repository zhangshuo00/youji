...
const Sider = () => {
    ...
    useEffect(()=>{
        ...
        forwardTiming(datas.registration_date);
    ...
    function forwardTiming(registration_date){
        console.log(registration_date) 
            ...
            console.log(now);
            setdatas({diffDate : (now.getTime() - forward.getTime())/1000/60/60/24})
            console.log(datas.diffDate)
    }
    ...
    return (
        <View>
            ...
            <View style={styles.siderTabs}>
                ...
                <View style={styles.siderTabItem}>
                    <Text style={styles.siderTabsText}>你已经来到有纪{datas.diffDate}天了！</Text>
                </View>
            </View>
