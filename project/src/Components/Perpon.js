    ...
    render() {
        return (
            ...
            <div className="picture">
                ...
                {/* <img src={require(`../images/2-191015104P02N.jpg`)} style={{width: '90%',height: '154px',marginTop:'-10%'}}></img> */}
                <Icon onClick={()=>{window.location='/newperpon'}} key="0" type="plus" style={{ marginLeft: '80%' }}></Icon>
            </div>
            <div className="p">
                <img src={require(`../images/timg.jpg`)} style={{width: '50px',height: '50px',borderRadius: '100px'}}></img><span className="p1">有纪</span>
